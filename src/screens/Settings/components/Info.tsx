  ...
  return (
    <div className={styles.settingsCategory}>
      ...
      <p className={styles.categoryDesc}>
        ...
        &
        <a className={styles.link} href="https://developer.yr.no/">
          {' '}
      ...
      <div className={styles.contactWrapper}>
        ...
        <a
          href="https://mrlaude.com/"
          className={styles.itemContact + ' ' + styles.itemContactLink}
        >
        ...
        <a
          href="https://www.instagram.com/martinryberglaude/"
          className={styles.itemContact + ' ' + styles.itemContactLink}
        >
